...
અમે મોડ્યુલર કિચન શટર અને સોફા ફ્રેમ્સ સીધા અમારા વર્કશોપમાં જ બનાવીએ છીએ જેથી તમને હોલસેલ રેટ મળી શકે. મટિરિયલના સેમ્પલ (લેમિનેટ્સ, વિનિયર્સ, ક્વાર્ટઝ કાઉન્ટરટોપ અને બ્રાન્ડેડ હાર્ડવેર) જોવા માટે અમારા ગોટા શોરૂમની મુલાકાત લો.`;
      } else if (isPricingQuery) {
        reply = `💰 **કિંમત અને બજેટ અંદાજ:**
અમે વચેટિયા વિના સીધા અમારા ગોટા વર્કશોપમાંથી જ ઉત્પાદન સપ્લાય કરીએ છીએ, તેથી અમે **ફેક્ટરી-ડાયરેક્ટ રેટ** ઓફર કરીએ છીએ!
...
- **ગોટા લક્ઝરી પેન્ટહાઉસ** (ગોટા, અમદાવાદ): સ્માર્ટ પ્રોફાઇલ ગ્લાસ વોર્ડરોબ અને કસ્ટમ કબાટ.
