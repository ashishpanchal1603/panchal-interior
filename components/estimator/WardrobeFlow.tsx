  ...
  return (
    <div>
      ...
      {step === 1 && (
        ...
        >
          <div className="text-center md:text-left">
            <h3 className="font-outfit text-xl sm:text-2xl font-bold text-stone-900">Select Wardrobe Style</h3>
      ...
      {step === 2 && (
        ...
        >
          <div className="text-center md:text-left">
            <h3 className="font-outfit text-2xl font-bold text-stone-900">Define Wardrobe Sizing</h3>
      ...
      {step === 3 && (
        ...
        >
          <div className="text-center md:text-left">
            <h3 className="font-outfit text-xl sm:text-2xl font-bold text-stone-900">Choose Door Finish</h3>
            <p className="text-stone-500 text-xs sm:text-sm mt-0.5">
