  ...
  return (
    <div>
      ...
      {step === 1 && (
        ...
        >
          <div className="text-center md:text-left">
            <h3 className="font-outfit text-2xl font-bold text-stone-900">Select Kitchen Layout</h3>
      ...
      {step === 2 && (
        ...
        >
          <div className="text-center md:text-left">
            <h3 className="font-outfit text-2xl font-bold text-stone-900">Define Kitchen Dimensions</h3>
            <p className="text-stone-500 text-sm mt-1">
      ...
      {step === 3 && (
        ...
        >
          <div className="text-center md:text-left">
            <h3 className="font-outfit text-xl sm:text-2xl font-bold text-stone-900">Choose Shutter Materials & Finish</h3>
