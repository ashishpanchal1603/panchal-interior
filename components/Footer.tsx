      ...
      <div className="max-w-7xl mx-auto px-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="space-y-5">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" className="flex h-9 w-9 items-center justify-center rounded-full bg-stone-900 text-stone-400 hover:bg-primary hover:text-white transition">
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm">
            ...
            <li className="flex gap-3 items-center">
              ...
              <a href="tel:+919876543210" className="hover:text-white transition font-semibold text-white">
                +91 9925111438
              </a>
            </li>
            <li className="flex gap-3 items-center">
