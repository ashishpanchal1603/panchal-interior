    ...
    <div className="fixed bottom-4 left-4 right-4 z-50 md:hidden">
      <div className="flex items-center justify-between bg-stone-950/95 backdrop-blur-md border border-stone-800/80 px-4 py-2.5 rounded-2xl shadow-2xl max-w-md mx-auto">
        ...
        >
          ...
          <span className="text-[10px] font-bold tracking-wide mt-1">Call</span>
        </a>
        ...
        {/* WhatsApp Option */}
        <a
          href="https://wa.me/919664956491?text=Hello%20Panchal%20Interior%2C%20I'm%20interested%20in%20your%20interior%20design%20and%20furniture%20services.%20Could%20we%20connect%3F"
          target="_blank"
